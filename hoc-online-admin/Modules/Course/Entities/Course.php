...
class Course extends Model
{
    ...
    public static function genColumnHtml($data){
        ...
        if(!empty($data)){
            $collum = '<a href="#" onClick="return courseHelper.edit('. $data->id . ')" class="btn btn-xs btn-primary"><i class="fa fa-pencil">Sửa</i></a>
                       <a href="'. route('course.delete', $data->id) .'" onclick="return confirm('.$message.')" class="btn btn-xs btn-danger"><i class="fa fa-trash">Xoá</i></a>';
    ...
    public function class(){
        return $this->hasMany('Modules\Course\Entities\Classroom', 'course_id');
    }
}
