                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" value="{{ $exercise->name }}" class="form-control" placeholder="Nhập vào tên bài tập" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nội dung bài tập</label>
                            <input type="file" name="content" class="form-control preview-upload-image"/>
                            <img src="{{asset('/img/exercise/'.$exercise->content )}}" alt="" class="preview-feature-image preview-image"/>
                        </div>
                        <div class="form-group">
                            <label>Khối lớp</label>
                            <select id="course" class="form-control" onchange="filterStudy($(this).val(), 'theory_group')">
                        ...
                        <div class="form-group">
                            ...
                            <select id="classroom" class="form-control" onchange="filterStudy($(this).val(), 'theory')">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-inline">
                                ...
                                <button id="submit_count" type="button" class="form-control btn-dark">Tạo đáp án</button>
                            </div>
                        </div>
                        <div id="answer">
                            <div class="form-group">
                                @foreach($answers as $key => $answer)
                                    ...
                                    <div class="form-inline">
                                        @for($j = 1; $j <= count(\Modules\Course\Entities\Exercise::listAnswer()) ; $j ++)
                                            <input class="form-check-input" type="radio" <?php echo ($j == $answer)? "checked" : ""?> name='answer[{{$key + 1}}][]' value="{{ $j }}">
                                            <label class="form-check-label" for="">{{ \Modules\Course\Entities\Exercise::listAnswer()[$j] }}</label>
                                        @endfor
                                    </div>
                                @endforeach
                            </div>
