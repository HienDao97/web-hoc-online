{!! Form::open(['method' => 'POST', 'route' => ['theory.group.edit', $item->id], 'class' => 'validate', 'id' => 'form-input']) !!}
    ...
    <div class="col-md-12">
        <div class="box no-border">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Miêu tả(*)</label>
                    <textarea name="description" class="form-control" placeholder="Nhập vào thông tin về khoá học" required>{{ $item->description }}</textarea>
                </div>
            </div>
