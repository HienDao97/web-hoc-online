                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-success btn-sm" href="#" onClick="return theoryHelper.create()">Thêm mới bài tậpc</a>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-body">
        ...
        $(function() {
            table=$('#post_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'classroom_name', name:'theory.classroom_name'},
                    {data: 'course_name', name:'theory.course_name'},
                    {data: 'content', name:'theory.content'},
                    {data: 'video_link', name:'theory.video_link'},
