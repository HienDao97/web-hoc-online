{!! Form::open(['method' => 'POST', 'route' => ['course.edit', $item->id], 'class' => 'validate', 'id' => 'form-input']) !!}
        ...
        <div class="box no-border">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input name="name" type="text" value="{{ $item->name }}" class="form-control" placeholder="Nhập vào tên khoá học" required>
                </div>
                <div class="form-group">
                    <label>Mã khoá học(*)</label>
                    <input name="code" type="text" value="{{ $item->code }}" class="form-control" placeholder="Nhập vào mã khoá học" required>
                </div>
                <div class="form-group">
                    <label>Thông tin về khoá học(*)</label>
                    <textarea name="class_info" class="form-control" placeholder="Nhập vào thông tin về khoá học" required>{{ $item->class_info }}</textarea>
                </div>
            </div>
