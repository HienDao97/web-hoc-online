            ...
            <div class="box no-border">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="code" type="text" value="{{ old('name') }}" class="form-control" placeholder="Nhập vào mã khoá học" required>
                    </div>
                    <div class="form-group">
                        <label>Thông tin về khoá học(*)</label>
                        <textarea name="class_info" class="form-control" placeholder="Nhập vào thông tin về khoá học" required></textarea>
                    </div>
                </div>
