...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Danh sách các lớp học</li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-success btn-sm" href="#" onClick="return classroomHelper.create()">Thêm mới lớp học</a>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-body">
    ...
    <script>
        ...
        $(function() {
            table=$('#post_table').DataTable({
                ...
                columns: [
                    {data: 'id'},
                    {data: 'class_name', name:'classroom.class_name'},
                    {data: 'code', name:'classroom.code'},
                    {data: 'name', name:'classroom.name'},
                    {data: 'tuition', name:'classroom.tuition'},
                    {data: 'status', name:'classroom.status'},
                    {data: 'number_of_unit', sortable: true,name:'classroom.number_of_unit'},
