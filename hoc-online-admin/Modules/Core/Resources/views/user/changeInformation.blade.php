    ...
    <section class="content">
        <div class="box box-default">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="textbox" value="{{$user->username}}" class="form-control" placeholder="{{trans('core::user.enter_name')}}" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <img @if($user->avatar!="") src="{{ asset('image/admin').'/'.$user->avatar}}" @else src="{{asset('/img/placeholder.jpg')}}" @endif  class="preview-feature-image preview-image"/>
                        </div>
                        <!-- /.form-group -->
                    </div>
                </div>
            ...
            <div class="box-footer">
                <a href="{{ route('admin_home') }}" class="btn btn-default pull-right">{{trans('core::user.cancel')}}</a>
