...
var projectHelper = (function(){
    return {
        create : function () {
            on();
            $.get('/public/utilities/project/create', null, function (result) {
                off();
        ...
        edit : function (id) {
            on();
            $.get('/public/utilities/project/edit/'+id ,null, function (result) {
                    off();
        ...
        editdecentralization : function (id) {
            on()
            $.get('/public/utilities/project/editdecentralization/'+id ,null, function (result) {
                off();
...
var checkDeleteRegion = (function(){
    return {
        delete: function(id){
            on();
            $.get({
                url: '/public/news/news_region/checkDelete',
                type: 'GET',
                data: {
                    id: id
                },
...
var BlockHelper = (function(){
    return {
        detail: function(id){
            on();
            $.get('/public/news/news_block/detail/'+id, null, function(result){
                off();
...
var regionHelper = (function(){
    return {
        create: function(){
            on();
            $.get('/public/news/news_region/create', null, function (result) {
                off();
        ...
        edit : function (id) {
            on();
            $.get('/public/news/news_region/edit/'+id ,null, function (result) {
                off();
