                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Email(*)</label>
                            <input name="email" type="email" value="{{ $student->email }}" class="form-control" placeholder="Nhập vào email người dùng" required>
                        </div>
                        <div class="form-group">
                            <label>Họ và tên(*)</label>
                            <input name="name" type="textbox" value="{{ $student->name }}" class="form-control" placeholder="Nhập vào tên người dùng" required>
                        </div>
