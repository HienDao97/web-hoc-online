{!! Form::open(['method' => 'POST', 'route' => ['document.edit', $item->id], 'class' => 'validate', 'id' => 'form-input']) !!}
        ...
        <div class="box no-border">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input name="title" type="text" value="{{ $item->title }}" class="form-control" placeholder="Nhập vào tên lớp học" required>
                </div>
                <div class="form-group">
                    <label>Link tài liệu(*)</label>
                    <input name="link" type="text" class="form-control" value="{{ $item->link }}" placeholder="Nhập vào thông tin về link video" required>
                </div>
                <div class="form-group">
