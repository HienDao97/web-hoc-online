        ...
        <div class="box no-border">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label>Năm học(*)</label>
                    <input name="name" type="text" value="{{ $item->name }}" class="form-control" placeholder="Nhập vào năm học" required>
                </div>
                <div class="form-group">
                    <label>Mã năm học(*)</label>
                    <input name="code" type="text" value="{{ $item->code }}" class="form-control" placeholder="Nhập vào mã năm học" required>
                </div>
                <div class="form-group">
                    <label>Thông tin về năm học(*)</label>
                    <textarea name="class_info" class="form-control" placeholder="Nhập vào thông tin về năm học" required>{{ $item->class_info }}</textarea>
                </div>
            </div>
