        ...
        <div class="box no-border">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input name="name" type="text" value="{{ old('email') }}" class="form-control" placeholder="Nhập vào tên bài học" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="classroom_id" id="classroom1">
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.result == 0){
                    ...
                    $("#classroom1").html("");
                    $("#classroom1").append(data.message);
                }
