...
class Permission
{
    ...
    public static function getListPermissions()
    {
        return [
            ...
            'Modules\Course\Http\Controllers\ClassroomController' => [
                'id' => 5,
                'actions' => [
                    "index" => [
                        "id" => 20,
            ...
            'Modules\Course\Http\Controllers\CourseController' => [
                'id' => 6,
                'actions' => [
                    "index" => [
                        "id" => 24,
            ...
            'Modules\Course\Http\Controllers\ExerciseController' => [
                'id' => 7,
                'actions' => [
                    "index" => [
                        "id" => 28,
            ...
            'Modules\Product\Http\Controllers\TheoryController' => [
                'id' => 8,
                'actions' => [
                    "index" => [
                        "id" => 32,
            ...
            'Modules\Student\Http\Controllers\StudentController' => [
                'id' => 9,
                'actions' => [
                    "index" => [
                        "id" => 36,
